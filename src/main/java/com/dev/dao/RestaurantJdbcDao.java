...
public class RestaurantJdbcDao {
    ...
    public void createRestaurant(Restaurant restaurant) {
        String sql = "INSERT INTO Restaurant (RestaurantId, RestaurantName, RestaurantDescription, StreetAddress, PhoneNumber, City, Pincode, State, StartTime, EndTime, Rating, NumberOfUsersRated) VALUES (:RestaurantId, :RestaurantName, :RestaurantDescription, :StreetAddress, :PhoneNumber, :City, :Pincode, :State, :StartTime, :EndTime, :Rating, :NumberOfUsersRated)";
